...
(async () => {
    ...
    try {
        ...
        // A sintaxe da documentação com 'new' é a correta para módulos ES
        ...
        for (const file of htmlFiles) {
            ...
            const slideHeight = await page.$eval('.slide-container', element => element.scrollHeight);
            // const slideHeight = await page.$eval('.slide', element => element.scrollHeight);
