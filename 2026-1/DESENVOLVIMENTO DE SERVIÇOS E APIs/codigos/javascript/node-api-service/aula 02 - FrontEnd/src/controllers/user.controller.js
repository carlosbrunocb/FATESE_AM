...
class UserController {
    ...
    async getAll(req, res) {
        ...
        // Envia a resposta HTTP no formato JSON com o status 200 (OK - padrão).
    ...
    async create(req, res) {
        ...
        // Isso é possível graças ao middleware `express.json()` que parseia o JSON recebido.
        // Chama o método 'create' do Service, passando os dados do novo usuário.
        const newUser = userService.create(req.body);
        // Envia a resposta HTTP com o status 201 (Created - Criado com sucesso)
        // e retorna os dados do usuário recém-criado.
