...
// HELMET: Oculta headers sensíveis e protege contra vulnerabilidades web comuns (XSS, etc)
app.use(helmet());

// RATE LIMIT: Previne ataques de Força Bruta e DDoS
const limiter = rateLimit({
    windowMs: 15 * 60 * 1000, // 15 minutos
    max: 100, // Limita cada IP a 100 requisições por janela
    message: { erro: "Muitas requisições a partir deste IP. Tenta novamente mais tarde." }
});

// Aplica o limite apenas nas rotas que começam por /api
app.use('/api/', limiter);
